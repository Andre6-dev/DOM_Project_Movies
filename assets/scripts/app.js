...
const startDeleteMovieHandler = (movieId) => {
    ...
    // Creamos un clon del boton de confirmacion para que no se tenga varios EventListeners y se puedan borrar.
...
startaAddMovieButton.addEventListener('click', showMovieModal);
